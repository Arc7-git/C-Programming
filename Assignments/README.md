...
A collection of basic C programming assignments.

## 📋 Assignments

| Assignment | File | Description |
| :--- | :--- | :--- |
| **Assignment 1** | [`A1.c`](./A1.c) | Check if a given year is a leap year |
| **Assignment 2** | [`A2.c`](./A2.c) | Menu-driven arithmetic calculator using `switch` |
